<?php
    ...
    if (mysqli_connect_errno()) {
        ...
        $sql =  "SELECT user.username,user.password FROM user WHERE user.username = '".$username."' AND user.password = '".$password_encrypt."' AND user.active = 1 ";
        ...
        if(strcmp($flag,"1")==0){
            ...
            evaluateRoleUser($username,$conn);
        }else{
    ...
    function evaluateRoleUser($user,$conx){
        $sql1 = "SELECT role_id FROM user_role WHERE username = '".$user."' ";
